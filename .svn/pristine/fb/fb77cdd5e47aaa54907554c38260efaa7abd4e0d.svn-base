...
static void l_addsubX(std::string in1,std::string in2, std::string out, CodeSet & codeset,bool add,bool cy)
{
    //add/sub
    {
        ...
        if (cy)
        {
            ...
            part.getCode() = part.getCode() + "\t\tif (((*((OR1K*)cpu)->SR)&OR1K_SR_CY) != 0) {"+out+" = "+out+" "+(add?"+":"-")+" 1; d = d "+(add?"+":"-")+"1 ;}";
        }
    }
    ...
    //carry
    {
        ...
        part.getCode() = "\t\tif (unlikely(d != (uint64_t)((uint32_t)("+out+")))) (*((OR1K*)cpu)->SR) |= OR1K_SR_CY; else (*((OR1K*)cpu)->SR) &= ~OR1K_SR_CY;";
    }
    ...
    //overflow
    {
        ...
        part.getCode() = std::string("\t\tif (unlikely(((a&(1<<31)) ")+(add?"==":"!=") +" (b&(1<<31))) && ((a&(1<<31)) != (d&(1<<31))))) (*((OR1K*)cpu)->SR) |= OR1K_SR_OV; else (*((OR1K*)cpu)->SR) &= ~OR1K_SR_OV;";
    }
    ...
    "\t\t\t\tif (((a&(1<<31)) == (b&(1<<31))) && ((a&(1<<31)) != (d&(1<<31)))) (*((OR1K*)cpu)->SR) |= OR1K_SR_OV; else (*((OR1K*)cpu)->SR) &= ~OR1K_SR_OV;\n"
    "\t\t\t\tif (d != ("+out+")) (*((OR1K*)cpu)->SR) |= OR1K_SR_CY; else (*((OR1K*)cpu)->SR) &= ~OR1K_SR_CY;\n"
...
static bool shift(BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic){
    ...
    part.getRegisterDependencies().add(reg_name[irB],32);
    part.getAffectedRegisters().add(reg_name[irD],32);
	part.code() = std::string(reg[irD])+" = (("+(sig?"etiss_int32)":"etiss_uint32)")+reg[irA]+(right?")>>(":")<<(")+(imm?toString(imme):(std::string(reg[irB])+"&0x1f"))+");";
...
static bool loadinstr(BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    "etiss_int32 or1k_exception = (*(system->dread))(system->handle,cpu,(" << reg[ra.read(ba)] << "+" << (int16_t)immediate.read(ba) << "),or1k_buf," << sizeof(T) << ");\n";
    if (swap)
    {
		if (sizeof(T)>=2)
        ...
        {
            ss <<	"or1k_tmpswap = or1k_buf["<<i<<"]; or1k_buf["<<i<<"] = or1k_buf["<<(sizeof(T)-1-i)<<"]; or1k_buf["<<(sizeof(T)-1-i)<<"] = or1k_tmpswap;";
        }
    }
...
static bool storeinstr(BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    ss <<	"etiss_int32 or1k_exception = (*(system->dwrite))(system->handle,cpu,(" << reg[ra.read(ba)] << "+" << toString((int16_t)((immp1.read(ba)<<11) | immp2.read(ba))) << "),or1k_buf," << sizeof(T) << ");\n";
    CodePart & cp = cs.append(CodePart::INITIALREQUIRED);
    cp.code() = ss.str();
    cp.getAffectedRegisters().add(reg_name[rd.read(ba)],32);
    cp.getRegisterDependencies().add(reg_name[ra.read(ba)],32);
...
static InstructionDefinition l_addc(
    ORBIS32_I,
...
static InstructionDefinition l_addi(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    l_addsubX(reg[ra.read(ba)],toString((int16_t)immediate.read(ba)), reg[rd.read(ba)], cs,true,false);
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_addic(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    ...
    l_addsubX(reg[ra.read(ba)],toString((int16_t)immediate.read(ba)), reg[rd.read(ba)], cs,true,true);
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_and(
    ORBIS32_I,
...
static InstructionDefinition l_andi(
    ORBIS32_I,
...
static InstructionDefinition l_bf(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    ...
    ss << "		((OR1K*)cpu)->instructionPointer_delayed = (uint32_t)(" << ic.current_address_ << "ULL + " << (uint32_t)(((int32_t)((int16_t)immediate.read(ba)))<<2) << "ULL);";
    ss << "	}else{";
    ss << "		((OR1K*)cpu)->instructionPointer_delayed = (uint32_t)(" << ic.current_address_ << "ULL + 8);";
    ss << "}";
    CodePart & cp = cs.append(CodePart::INITIALREQUIRED);
...
static InstructionDefinition l_bnf(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    ...
    ss << "		((OR1K*)cpu)->instructionPointer_delayed = (uint32_t)(" << ic.current_address_ << "ULL + " << (uint32_t)(((int32_t)((int16_t)immediate.read(ba)))<<2) << ");";
    ss << "	}else{";
    ss << "		((OR1K*)cpu)->instructionPointer_delayed = (uint32_t)(" << ic.current_address_ << "ULL + 8);";
    ss << "}";
    CodePart & cp = cs.append(CodePart::INITIALREQUIRED);
...
static InstructionDefinition l_j(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    uint32_t jaddr = (uint32_t)( ic.current_address_ + ((((int32_t)limmediate.read(ba))<<6)>>4) );
    std::stringstream ss;
    ss << "		((OR1K*)cpu)->instructionPointer_delayed = (uint32_t)" + toString(jaddr) + "ULL;";
    CodePart & cp = cs.append(CodePart::INITIALREQUIRED);
    cp.code() = ss.str();
    update_pc<true,true>(ba,cs,ic);
    return true;
...
static InstructionDefinition l_jal(
    ORBIS32_I,
...
static InstructionDefinition l_jalr(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    ...
    std::stringstream ss;
    ss << "		((OR1K*)cpu)->instructionPointer_delayed = (uint32_t)(" << reg[rb.read(ba)] << ");";
    ss << "		((OR1K*)cpu)->R[9] = " + toString(ic.current_address_ + 8) + ";";
    CodePart & cp = cs.append(CodePart::INITIALREQUIRED);
...
static InstructionDefinition l_jr(
    ORBIS32_I,
...
static InstructionDefinition l_lbs(
    ORBIS32_I,
...
static InstructionDefinition l_lbz(
    ORBIS32_I,
...
static InstructionDefinition l_lhs(
    ORBIS32_I,
...
static InstructionDefinition l_lhz(
    ORBIS32_I,
...
static InstructionDefinition l_lws(
    ORBIS32_I,
...
static InstructionDefinition l_lwz(
    ORBIS32_I,
...
static InstructionDefinition l_mfspr(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    ...
    cp.code() = std::string(reg[rd.read(ba)])+" = OR1KArch_mfspr((OR1K*)cpu," + reg[ra.read(ba)] +"|" + toString(immediate.read(ba)) + ");";
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_movhi(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    ...
    CodePart & cp = cs.append(CodePart::INITIALREQUIRED);
    cp.code() = std::string(reg[rd.read(ba)]) + " = (etiss_uint32) " + toString(((uint32_t)immediate.read(ba))<<16) + ";" ;
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_mtspr(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
    ...
    BitArrayRange immp1(25,21);
    BitArrayRange immp2(10,0);
    cp.code() = std::string("OR1KArch_mtspr((OR1K*)cpu,") + reg[ra.read(ba)] +"|" + toString((immp1.read(ba)<<11) | immp2.read(ba)) + ", " + reg[rb.read(ba)] + " );";
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_nop(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext &ic)
{
	...
	if (nopcode != NOP_NOP){
		...
		if (nopcode == NOP_REPORT){
			cs.append(CodePart::INITIALREQUIRED).code() = std::string("OR1K_report((uint32_t)") + reg[3] + " );";
		}
		if (nopcode == NOP_PUTC){
			cs.append(CodePart::INITIALREQUIRED).code() = std::string("OR1K_printchar((char)") + reg[3] + " );";
		}
		if (nopcode == NOP_GET_PS){
			cs.append(CodePart::INITIALREQUIRED).code() = std::string(reg[11]) + " = (etiss_uint32) (cpu->cpuCycleTime_ps);";
		}
...
static InstructionDefinition l_or(
    ORBIS32_I,
...
static InstructionDefinition l_ori(
    ORBIS32_I,
...
static InstructionDefinition l_sb(
    ORBIS32_I,
...
static InstructionDefinition l_sfeq(
    ORBIS32_I,
...
static InstructionDefinition l_sfges(
    ORBIS32_I,
...
static InstructionDefinition l_sfgeu(
    ORBIS32_I,
...
static InstructionDefinition l_sfgts(
    ORBIS32_I,
...
static InstructionDefinition l_sfgtu(
    ORBIS32_I,
...
static InstructionDefinition l_sfles(
    ORBIS32_I,
...
static InstructionDefinition l_sfleu(
    ORBIS32_I,
...
static InstructionDefinition l_sflts(
    ORBIS32_I,
...
static InstructionDefinition l_sfltu(
    ORBIS32_I,
...
static InstructionDefinition l_sfne(
    ORBIS32_I,
...
static InstructionDefinition l_sh(
    ORBIS32_I,
...
static InstructionDefinition l_sll(
    ORBIS32_I,
...
static InstructionDefinition l_slli(
    ORBIS32_I,
...
static InstructionDefinition l_sra(
    ORBIS32_I,
...
static InstructionDefinition l_srai(
    ORBIS32_I,
...
static InstructionDefinition l_srl(
    ORBIS32_I,
...
static InstructionDefinition l_srli(
    ORBIS32_I,
...
static InstructionDefinition l_sub(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    l_addsubX(std::string("(((OR1K*)cpu)->R[")+toString(ra.read(ba))+"])",std::string("(((OR1K*)cpu)->R[")+toString(rb.read(ba))+"])", std::string("(((OR1K*)cpu)->R[")+toString(rd.read(ba))+"])", cs,false,false);
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_sw(
    ORBIS32_I,
...
static InstructionDefinition l_sys(
    ORBIS32_I,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic){
		cs.append(CodePart("return OR1K_SYSTEMCALLEXCEPTION +"+toString(immediate.read(ba)&0x0000FFFF)+";"),CodePart::APPENDEDRETURNINGREQUIRED);
		update_pc<true,false>(ba,cs,ic);
		return true;
	},
...
static InstructionDefinition l_xor(
    ORBIS32_I,
...
static InstructionDefinition l_xori(
    ORBIS32_I,
