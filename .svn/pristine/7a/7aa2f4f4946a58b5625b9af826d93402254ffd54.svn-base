...
static void parseName(const char * cname,const int baseflags,unsigned & flags,std::string & name_)
{
    ...
    {
        etiss::log(etiss::WARNING,"etiss::VirtualStruct::allocateFromC encountered an invalid field name. flags cannot be parsed and will be set to private. check the documentation of VirtualStruct_names for the propper syntax",name);
