...
static bool l_cust (BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    case 2: //l.cust2 // get cpu time
        cs.append(CodePart::INITIALREQUIRED).code() = std::string(reg[rd.read(ba)]) + " = (etiss_uint32) (cpu->cpuTime_ps/1000000);";
        break;
    case 3: //l.cust3
...
static void OR1K_l_mulX(const std::string rD,const std::string rA,const std::string rB,CodeSet & codeset)
{
    ...
    //flag
    {
        ...
        part.code() =	 std::string("etiss_int32 OR1K_high = OR1K_result >> 32; etiss_int32 OR1K_cy = OR1K_result >> 31;\n")
                         +"*((OR1K*)cpu)->SR = ((*((OR1K*)cpu)->SR) & ~OR1K_SR_OV) | ((((OR1K_cy==0)&&(OR1K_high==0))||((OR1K_cy==-1)&&(OR1K_high==-1)))?0:OR1K_SR_OV);";
    }
    //exception
    {
        ...
        ss << "etiss_int32 OR1K_high_ = OR1K_result >> 32; etiss_int32 OR1K_cy_ = OR1K_result >> 31;\n*((OR1K*)cpu)->SR = ((*((OR1K*)cpu)->SR) & ~OR1K_SR_OV) | ((((OR1K_cy_==0)&&(OR1K_high_==0))||((OR1K_cy_==-1)&&(OR1K_high_==-1)))?0:OR1K_SR_OV);";
...
static void OR1K_l_muluX(const std::string rD,const std::string rA,const std::string rB,CodeSet & codeset)
{
    //op
    {
        ...
        part.code() = 	 "etiss_uint32 OR1K_rA = (etiss_uint32)"+rA+";\n"
                         +"etiss_uint32 OR1K_rB = (etiss_uint32)"+rB+";\n"
    ...
    //flag
    {
        ...
        part.code() =	 "*((OR1K*)cpu)->SR = ((*((OR1K*)cpu)->SR) & ~OR1K_SR_CY) | (((OR1K_result>>32)!=0)?0:OR1K_SR_CY);";
    }
    //exception
    {
        CodePart & part = codeset.append(CodePart::APPENDEDRETURNINGREQUIRED);
...
static InstructionDefinition l_cust1(
    ORBIS32_II,
...
static InstructionDefinition l_cust2(
    ORBIS32_II,
...
static InstructionDefinition l_cust3(
    ORBIS32_II,
...
static InstructionDefinition l_cust4(
    ORBIS32_II,
...
static InstructionDefinition l_cust5(
    ORBIS32_II,
...
static InstructionDefinition l_cust7(
    ORBIS32_II,
...
static InstructionDefinition l_cust8(
    ORBIS32_II,
...
static InstructionDefinition l_cmov(
    ORBIS32_II,
...
{
    cs.append(CodePart::APPENDEDRETURNINGREQUIRED).code() = std::string(reg[rd.read(ba)]) + " = ((*((OR1K*)cpu)->SR)&OR1K_SR_F)?(" + reg[ra.read(ba)] + "):(" + reg[rb.read(ba)] + ");";
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_csync(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    std::stringstream ss;
    ss << "etiss_int32 regb = (etiss_int32) ((OR1K*)cpu)->R[" << reg[rb.read(ba)] << "];\n";
    ss << "if (regb != 0){\n";
    ss << "((OR1K*)cpu)->R[" << reg[rd.read(ba)] << "] = (etiss_uint32) ((etiss_int32) " << reg[ra.read(ba)] << " / regb);";
    ss << "}\n";
    ...
    cp.getAffectedRegisters().add(reg_name[rd.read(ba)],32);
    cs.append(CodePart::APPENDEDRETURNINGREQUIRED).code() = "if (regb == 0 && (*((OR1K*)cpu)->AECR & (1<<4)) && (*((OR1K*)cpu)->sR & (1<<12)) ) return OR1K_RANGEEXCEPTION;";
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    std::stringstream ss;
    ss << "etiss_uint32 regb = (etiss_int32) ((OR1K*)cpu)->R[" << reg[rb.read(ba)] << "];\n";
    ss << "if (regb != 0){\n";
    ss << "((OR1K*)cpu)->R[" << reg[rd.read(ba)] << "] = (etiss_uint32) ((etiss_uint32) " << reg[ra.read(ba)]  <<" / regb);";
    ss << "}\n";
    ss << "*((OR1K*)cpu)->SR = ((*((OR1K*)cpu)->SR) & ~OR1K_SR_OV) | (regb==0?(OR1K_SR_OV):0);";
    CodePart & cp = cs.append(CodePart::INITIALREQUIRED);
    cp.code() = ss.str();
...
static InstructionDefinition l_extbs(
    ORBIS32_II,
...
static InstructionDefinition l_extbz(
    ORBIS32_II,
...
static InstructionDefinition l_exths(
    ORBIS32_II,
...
static InstructionDefinition l_exthz(
    ORBIS32_II,
...
static InstructionDefinition l_extws(
    ORBIS32_II,
...
static InstructionDefinition l_extwz(
    ORBIS32_II,
...
static InstructionDefinition l_ff1(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    cs.append(CodePart::APPENDEDRETURNINGREQUIRED).code() =
				std::string("eitss_uint32 or1k_ff1 = 1;\n") +
...
static InstructionDefinition l_fl1(
    ORBIS32_II,
...
static InstructionDefinition l_mac(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
	...
	part.code() = 	 std::string("etiss_int64 OR1K_rA = (etiss_int32)")+reg[ra.read(ba)]+";\n"
			+"etiss_int64 OR1K_rB = (etiss_int32)"+reg[rb.read(ba)]+";\n"
			"OR1K_rB = OR1K_rA * OR1K_rB;\n"
			"OR1K_rA = ((etiss_int64)(((etiss_uint64)*((OR1K*)cpu)->MACHI) << 32)) | ((etiss_uint64)(*((OR1K*)cpu)->MACLO));\n"
			"etiss_int64 OR1K_result = OR1K_rA + OR1K_rB;\n"
...
static InstructionDefinition l_maci(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    CodePart & part = cs.append(CodePart::INITIALREQUIRED);
	part.code() = 	 std::string("etiss_int64 OR1K_rA = (etiss_int32)")+reg[ra.read(ba)]+";\n"
			+"etiss_int64 OR1K_rB = (etiss_int32)"+toString((uint16_t) immediate.read(ba))+";\n"
			"OR1K_rB = OR1K_rA * OR1K_rB;\n"
			"OR1K_rA = ((etiss_int64)(((etiss_uint64)*((OR1K*)cpu)->MACHI) << 32)) | ((etiss_uint64)(*((OR1K*)cpu)->MACLO));\n"
			"etiss_int64 OR1K_result = OR1K_rA + OR1K_rB;\n"
			"*((OR1K*)cpu)->MACHI = (etiss_uint32)(OR1K_result>>32);\n"
...
static InstructionDefinition l_macrc(
    ORBIS32_II,
...
static InstructionDefinition l_macu(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    CodePart & part = cs.append(CodePart::INITIALREQUIRED);
	part.code() = 	 std::string("etiss_uint64 OR1K_rA = (etiss_uint32)")+reg[ra.read(ba)]+";\n"
			+"etiss_uint64 OR1K_rB = (etiss_uint32)"+reg[rb.read(ba)]+";\n"
			"OR1K_rB = OR1K_rA * OR1K_rB;\n"
			"OR1K_rA = ((etiss_uint64)(((etiss_uint64)*((OR1K*)cpu)->MACHI) << 32)) | ((etiss_uint64)(*((OR1K*)cpu)->MACLO));\n"
			"etiss_uint64 OR1K_result = OR1K_rA + OR1K_rB;\n"
			"*((OR1K*)cpu)->MACHI = (etiss_uint32)(OR1K_result>>32);\n"
			"*((OR1K*)cpu)->MACLO = (etiss_uint32)(OR1K_result);";
	//TODO signed overflow flag
...
static InstructionDefinition l_msb(
    ORBIS32_II,
...
static InstructionDefinition l_msbu(
    ORBIS32_II,
...
static InstructionDefinition l_msync(
    ORBIS32_II,
...
static InstructionDefinition l_mul(
    ORBIS32_II,
...
static InstructionDefinition l_muld(
    ORBIS32_II,
...
static InstructionDefinition l_muldu(
    ORBIS32_II,
...
static InstructionDefinition l_muli(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    OR1K_l_mulX(reg[rd.read(ba)],reg[ra.read(ba)],toString((int16_t)immediate.read(ba)),cs);
    update_pc<false,false>(ba,cs,ic);
    return true;
},
...
static InstructionDefinition l_mulu(
    ORBIS32_II,
...
static InstructionDefinition l_psync(
    ORBIS32_II,
...
static InstructionDefinition l_ror(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    CodePart & part = cs.append(CodePart::INITIALREQUIRED);
	part.code() = std::string(reg[rd.read(ba)]) +"= ("+reg[ra.read(ba)] +">>("+reg[rb.read(ba)]+"&0x1F))|("+reg[ra.read(ba)]+"<<(32-("+reg[rb.read(ba)]+"&0x1F)));";
...
static InstructionDefinition l_rori(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    ...
    CodePart & part = cs.append(CodePart::INITIALREQUIRED);
	part.code() = std::string(reg[rd.read(ba)]) +"= ("+reg[ra.read(ba)] +">>("+toString(simm.read(ba)&0x1F)+"))|("+reg[ra.read(ba)]+"<<(32-("+toString(simm.read(ba)&0x1F)+")));";
...
static InstructionDefinition l_sfeqi(
    ORBIS32_II,
...
static InstructionDefinition l_sfgesi(
    ORBIS32_II,
...
static InstructionDefinition l_sfgeui(
    ORBIS32_II,
...
static InstructionDefinition l_sfgtsi(
    ORBIS32_II,
...
static InstructionDefinition l_sfgtui(
    ORBIS32_II,
...
static InstructionDefinition l_sflesi(
    ORBIS32_II,
...
static InstructionDefinition l_sfleui(
    ORBIS32_II,
...
static InstructionDefinition l_sfltsi(
    ORBIS32_II,
...
static InstructionDefinition l_sfltui(
    ORBIS32_II,
...
static InstructionDefinition l_sfnei(
    ORBIS32_II,
...
static InstructionDefinition l_trap(
    ORBIS32_II,
    ...
    [](BitArray & ba,etiss::CodeSet & cs,InstructionContext & ic)
{
    cs.append(CodePart::APPENDEDRETURNINGREQUIRED).code() = "return OR1K_TRAPEXCEPTION ;";
